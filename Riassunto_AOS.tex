...
\begin{table}[]
	...
	\resizebox{\textwidth/4*3}{!}{%
		\begin{tabular}{|m{\textwidth/11}|m{\textwidth/10}|m{\textwidth/11}|m{\textwidth/11}|m{\textwidth/11}|m{\textwidth/11}|m{\textwidth/11}|m{\textwidth/11}|m{\textwidth/9}|m{\textwidth/9}|m{\textwidth/8}|}
			\hline
...
\begin{table}[]
	...
	\caption{My caption}
	\label{my-label}
	\begin{tabular}{|m{\textwidth/11}|m{\textwidth/11}|m{\textwidth/11}|m{\textwidth/11}|}
		\hline
